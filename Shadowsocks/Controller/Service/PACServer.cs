...
using Shadowsocks.Controller.Net;
...
namespace Shadowsocks.Controller
{
    public class PACServer : StreamService
    {
        ...
        private readonly PACDaemon PacDaemon;

        public PACServer(PACDaemon PacDaemon)
        {
            this.PacDaemon = PacDaemon;
        }
        ...
        public void UpdatePACURL(Configuration config)
        {
            ...
            string contentHash = GetHash(PacDaemon.GetPACContent());
        ...
        public void SendResponse(Socket socket, bool useSocks)
        {
            try
            {
                ...
                string responseHead =
$@"HTTP/1.1 200 OK
Server: ShadowsocksWindows/{Client.Version}
