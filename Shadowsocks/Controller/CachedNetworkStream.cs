...
namespace Shadowsocks.Controller
{
    ...
    public class CachedNetworkStream : Stream
    {
        ...
        /// <returns></returns>
        public override Task WriteAsync(byte[] buffer, int offset, int count, CancellationToken cancellationToken) => s.WriteAsync(buffer, offset, count, cancellationToken);
