    ...
    public class UDPListener
    {
        ...
        public void Start()
        {
            if (CheckIfPortInUse(this._config.localPort))
                throw new Exception($"Port {this._config.localPort} already in use");
            ...
            logger.Info($"Shadowsocks started UDP ({Client.Version})");
            logger.Debug(Crypto.CryptoFactory.DumpRegisteredEncryptor());
