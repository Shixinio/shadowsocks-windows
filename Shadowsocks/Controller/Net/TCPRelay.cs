...
using static Shadowsocks.Crypto.CryptoBase;

namespace Shadowsocks.Controller.Net
{
    class TCPRelay : StreamService
    {
        ...
        public TCPRelay( Configuration conf)
        {
        ...
        public override bool Handle(CachedNetworkStream stream, object state)
        {
            ...
            TCPHandler handler = new TCPHandler(_config, socket);
    ...
    internal class TCPHandler
    {
        ...
        public const int ChunkOverheadSize = 16 * 2 /* two tags */ + AEADCrypto.ChunkLengthBytes;
        ...
        public TCPHandler(Configuration config, Socket socket)
        {
            // todo
            // _controller = controller;
